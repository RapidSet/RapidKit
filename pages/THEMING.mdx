import { ThemeGallery } from '../docs-nextra/components/ThemeGallery';
...
Scan every built-in theme at a glance. Each card renders its own palette, components, and chart strip live — click a card to load that theme into the playground.

<ThemeGallery />

## Live Preview

Inspect the active theme at full scale. Use the dropdown to switch, the toggle to preview dark mode locally.
