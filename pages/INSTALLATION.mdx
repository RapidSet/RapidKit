...
<DocsCodePreview
  language="bash"
  code={`pnpm add @tarikukebede/mezmer @reduxjs/toolkit @tanstack/react-table react react-dom react-hook-form react-redux zod tailwindcss`}
/>
...
<DocsCodePreview language="tsx" code={`import { Input } from '@tarikukebede/mezmer';
